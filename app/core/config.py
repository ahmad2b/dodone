...
class Settings(BaseSettings):
    ...
    PROJECT_NAME: str = "DoDone"
    SENTRY_DSN: HttpUrl | None = None
    POSTGRES_SERVER: str = "ep-spring-limit-a1yjjua4.ap-southeast-1.aws.neon.tech"
    POSTGRES_PORT: int = 5432
    POSTGRES_USER: str = "luffy"
    POSTGRES_PASSWORD: str = "LP4dBClR5AmW"
